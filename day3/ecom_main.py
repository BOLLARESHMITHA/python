...
from ecommerce_utils import apply_discount,add_gst,generate_invoice

cart = { "Laptop":55000,"Phone":30000,"Headphones":2000 }

dis_percent=int(input("enter discount percentage = "))
gst_percent=int(input("enter gst percentage = "))

generate_invoice(cart,dis_percent,gst_percent)